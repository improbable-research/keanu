...
comments: false
version:  0.0.26
permalink: /docs/ 0_0_26/particle-filter/
...
page_nav:
    prev:
        ...
        url: '/docs/ 0_0_26/regression/'
    next: 
        content: Next page
        url: '/docs/ 0_0_26/sequences/'
---

## Overview
Particle filters can help you find probable states of your network which can be used as starting states for [MCMC]({{ site.baseurl }}/docs/ 0_0_26/inference-posterior-sampling/) sampling. 
