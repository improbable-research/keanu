...
page_nav:
    prev:
        ...
        url: '/docs/0_0_21/vertex-summary/'
    next:
        content: Next page
        url: '/docs/0_0_21/inference-map/'
---
...
how we determine which dimension to broadcast along that can be found [here](https://docs/0_0_21.scipy.org/doc/numpy-1.15.0/user/basics.broadcasting.html).
