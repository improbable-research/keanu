...
comments: false
version: 0.0.19
permalink: /docs/0_0_19/vertex-summary/
...
A `BooleanVertex` can be used by most boolean operators. These can be observed directly and used in [MCMC]({{ site.baseurl }}/docs/0_0_19/inference-posterior-sampling/).
...
Read more about tensors [here]({{ site.baseurl }}/docs/0_0_19/tensors) 
