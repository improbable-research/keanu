...
comments: false
version: 0.0.16
permalink: /docs/0_0_16/vertex-summary/
...
A `BoolVertex` can be used by most boolean operators. These can be observed directly and used in [MCMC]({{ site.baseurl }}/docs/0_0_16/inference-posterior-sampling/).
...
Read more about tensors [here]({{ site.baseurl }}/docs/0_0_16/tensors) 
