...
comments: false
version: 0.0.16
permalink: /docs/0_0_16/installation/
...
Now that you have the starter project, head over to [getting started]({{ site.baseurl }}/docs/0_0_16/getting-started) to get started.
...
Now that you have the dependency, head over to [getting started]({{ site.baseurl }}/docs/0_0_16/getting-started).
