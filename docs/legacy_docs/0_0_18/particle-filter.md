...
comments: false
version: 0.0.18
permalink: /docs/0_0_18/particle-filter/
...
page_nav:
    ...
    next: 
        content: Next page
        url: '/docs/0_0_18/plates'
---

## Overview
Particle filters can help you find probable states of your network which can be used as starting states for [MCMC]({{ site.baseurl }}/docs/0_0_18/inference-posterior-sampling/) sampling. 
