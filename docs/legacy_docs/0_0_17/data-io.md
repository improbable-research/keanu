...
page_nav:
    ...
    next:
        content: Next page
        url: '/docs/0_0_17/vertex-summary/'
...
To learn more about the parameters being used here, head over to the [NUTS documentation]({{ site.baseurl }}/docs/0_0_17/inference-posterior-sampling#nuts).
