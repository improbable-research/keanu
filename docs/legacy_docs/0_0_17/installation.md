...
comments: false
version: 0.0.17
permalink: /docs/0_0_17/installation/
...
Now that you have the starter project, head over to [getting started]({{ site.baseurl }}/docs/0_0_17/getting-started) to get started.
...
Now that you have the dependency, head over to [getting started]({{ site.baseurl }}/docs/0_0_17/getting-started).
