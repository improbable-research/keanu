...
comments: false
version: 0.0.17
permalink: /docs/0_0_17/inference-map/
...
page_nav:
    ...
    next:
        content: Next page
        url: '/docs/0_0_17/inference-posterior-sampling'
---

## Model Fitting

Now that we've learnt to describe and build a model in [describing your model]({{ site.baseurl }}/docs/0_0_17/getting-started), we want to put 
...
Another technique for obtaining posterior estimates is through sampling. Read more about that on [posterior-sampling]({{ site.baseurl }}/docs/0_0_17/inference-posterior-sampling).
...
Let's say you've described the [thermometer model]({{ site.baseurl }}/docs/0_0_17/examples/thermometer) and want to run MAP but you're not sure
