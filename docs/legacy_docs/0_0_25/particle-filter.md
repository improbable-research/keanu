...
comments: false
version: 0.0.25
permalink: /docs/0_0_25/particle-filter/
...
page_nav:
    prev:
        ...
        url: '/docs/0_0_25/regression/'
    next: 
        content: Next page
        url: '/docs/0_0_25/sequences/'
---

## Overview
Particle filters can help you find probable states of your network which can be used as starting states for [MCMC]({{ site.baseurl }}/docs/0_0_25/inference-posterior-sampling/) sampling. 
