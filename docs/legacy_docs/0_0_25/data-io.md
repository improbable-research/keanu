...
page_nav:
    prev:
        ...
        url: '/docs/0_0_25/getting-started/'
    next:
        content: Next page
...
To learn more about the parameters being used here, head over to the [NUTS documentation]({{ site.baseurl }}/docs/0_0_25/inference-posterior-sampling#nuts).
