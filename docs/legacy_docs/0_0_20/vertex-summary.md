...
comments: false
version: 0.0.20
permalink: /docs/0_0_20/vertex-summary/
...
A `BooleanVertex` can be used by most boolean operators. These can be observed directly and used in [MCMC]({{ site.baseurl }}/docs/0_0_20/inference-posterior-sampling/).
...
Read more about tensors [here]({{ site.baseurl }}/docs/0_0_20/tensors) 
