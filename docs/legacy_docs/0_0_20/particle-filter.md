...
comments: false
version: 0.0.20
permalink: /docs/0_0_20/particle-filter/
...
## Overview
Particle filters can help you find probable states of your network which can be used as starting states for [MCMC]({{ site.baseurl }}/docs/0_0_20/inference-posterior-sampling/) sampling. 
