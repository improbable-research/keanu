...
comments: false
version:  0.0.26
permalink: /docs/ 0_0_26/installation/
...
Now that you have the starter project, head over to [getting started]({{ site.baseurl }}/docs/ 0_0_26/getting-started) to get started.
...
Now that you have the dependency, head over to [getting started]({{ site.baseurl }}/docs/ 0_0_26/getting-started).
