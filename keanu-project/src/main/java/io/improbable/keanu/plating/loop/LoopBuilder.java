...
public class LoopBuilder {
    ...
    /**
     * An optional method to override the default behaviour If the maximum loop count is exceeded,
     * it will log a warning instead of throwing
     *
     * @return self
     */
    ...
    public class LoopBuilder2 {
            ...
            try {
                ...
                valueOutWhenAlwaysTrue =
                        new DoubleProxyVertex(
                                VALUE_OUT_WHEN_ALWAYS_TRUE_LABEL.withExtraNamespace(
                                        "Loop_" + this.hashCode()));
                valueOutWhenAlwaysTrue.setParents(outputVertex);
            } catch (NoSuchElementException e) {
                throw new LoopConstructionException(
                        "You must pass in a base case, i.e. a vertex labeled as Loop.VALUE_OUT_LABEL",
                        e);
         ...
         *
         * @param iterationFunction a lambda that takes the Proxy input vertex and creates and
         *     returns a new output Vertex
                            ...
                            .withFactory(
                                    (plate) -> {
                                        ...
                                        DoubleVertex valueInWhenAlwaysTrue =
                                                new DoubleProxyVertex(
                                                        VALUE_IN_WHEN_ALWAYS_TRUE_LABEL);
                                        BoolVertex stillLooping =
                                                new BoolProxyVertex(Loop.STILL_LOOPING_LABEL);
                                        DoubleVertex valueIn =
                                                new DoubleProxyVertex(Loop.VALUE_IN_LABEL);
                                        ...
                                        DoubleVertex iterationResult =
                                                iterationFunction.apply(
                                                        plate, valueInWhenAlwaysTrue);
                                        ...
                                        DoubleVertex result =
                                                If.isTrue(loopAgain)
                                                        ...
                                                        .orElse(valueIn);
                                        plate.add(
                                                VALUE_OUT_WHEN_ALWAYS_TRUE_LABEL, iterationResult);
