...
public final class ModelComposition {
   ...
   *
   * <p>This function will take a previously constructed BayesNet and do a number of things: - Hook
   * up any Proxy Vertices to the parents specified in the inputVertices - Increment the depth for
   * all "internal" nodes and the BayesNet itself - Pass back any specified output nodes from the
   * Bayesnet (keeping them at the outer depth)
   *
