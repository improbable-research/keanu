...
public class ScalarDoubleTensor implements DoubleTensor {
  ...
  public DoubleTensor getLessThanMask(DoubleTensor lessThanThis) {
    if (lessThanThis.isScalar()) {
      ...
      return DoubleTensor.create(value, lessThanThis.getShape()).getLessThanMask(lessThanThis);
    }
  }
   ...
   * behaviour Which rounds negative numbers down if they end in 0.5 e.g. Java: round(-2.5) == -2.0
