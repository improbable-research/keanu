...
public class ScalarIntegerTensor implements IntegerTensor {
  ...
  public IntegerTensor getLessThanMask(IntegerTensor lessThanThis) {
    if (lessThanThis.isScalar()) {
      ...
      return IntegerTensor.create(value, lessThanThis.getShape()).getLessThanMask(lessThanThis);
    }
  }
  ...
  public IntegerTensor powInPlace(IntegerTensor exponent) {
    if (exponent.isScalar()) {
      ...
      return IntegerTensor.create(value, exponent.getShape()).powInPlace(exponent);
    }
    return this;
  }
  ...
  public IntegerTensor minusInPlace(IntegerTensor that) {
    if (that.isScalar()) {
      ...
      return IntegerTensor.create(value, that.getShape()).minusInPlace(that);
    }
    return this;
  }
  ...
  public IntegerTensor plusInPlace(IntegerTensor that) {
    if (that.isScalar()) {
      ...
      return IntegerTensor.create(value, that.getShape()).plusInPlace(that);
    }
    return this;
  }
  ...
  public IntegerTensor timesInPlace(IntegerTensor that) {
    if (that.isScalar()) {
      ...
      return IntegerTensor.create(value, that.getShape()).timesInPlace(that);
    }
    return this;
  }
  ...
  public IntegerTensor divInPlace(IntegerTensor that) {
    if (that.isScalar()) {
      ...
      return IntegerTensor.create(value, that.getShape()).divInPlace(that);
    }
    return this;
  }
  ...
  public String toString() {
    return "ScalarIntegerTensor{" + "value=" + value + '}';
  }
}
