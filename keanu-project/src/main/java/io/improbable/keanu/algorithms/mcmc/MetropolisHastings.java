...
public class MetropolisHastings implements PosteriorSamplingAlgorithm {
    ...
    public NetworkSamples getPosteriorSamples(
        ...
        return generatePosteriorSamples(
                        bayesianNetwork, Collections.singletonList(vertexToSampleFrom))
                .generate(sampleCount);
    }

    public NetworkSamplesGenerator generatePosteriorSamples(
            final BayesianNetwork bayesianNetwork,
    ...
    public static class Sampler implements SamplingAlgorithm {
        ...
        public void step() {
            ...
            logProbabilityBeforeStep =
                    mhStep.step(chosenVertices, logProbabilityBeforeStep)
    ...
    private static void checkBayesNetInHealthyState(BayesianNetwork bayesNet) {
        ...
        if (bayesNet.getLatentOrObservedVertices().isEmpty()) {
            throw new IllegalArgumentException(
                    "Cannot sample from a completely deterministic BayesNet");
