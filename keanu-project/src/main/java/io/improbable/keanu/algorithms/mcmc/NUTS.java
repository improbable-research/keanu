        ...
        if (treeHeight == 0) {
            ...
            if (tree.shouldContinueFlag) {
                ...
                if (buildDirection == -1) {
                    ...
                    tree.logOfMasterPAtPositionBackward = otherHalfTree.logOfMasterPAtPositionBackward;
                    ...
                    tree.logOfMasterPAtPositionForward = otherHalfTree.logOfMasterPAtPositionForward;
                }
