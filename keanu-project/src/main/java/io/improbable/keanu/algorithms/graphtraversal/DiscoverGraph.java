...
public class DiscoverGraph {
   ...
   *
   * <p>If the graph is very large (i.e. greater than 100k vertices), it will be much faster to keep
   * track of vertices as they are created than to create the graph and then collect it with this
   * method.
   *
