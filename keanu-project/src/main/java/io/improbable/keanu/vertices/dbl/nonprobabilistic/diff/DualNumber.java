...
public class DualNumber implements DoubleOperators<DualNumber> {
          ...
          thn.getPartialDerivatives()
              ...
              .add(
                  els.getPartialDerivatives()
                      .multiplyAlongOfDimensions(predicate.not().toDoubleMask(), ofShape));
      ...
      for (Map.Entry<VertexId, DoubleTensor> entry :
        ...
        if (!ids.contains(entry.getKey())) {
          vertexInfo.add(
              new Pair<>(
                  entry.getKey(),
                  Arrays.stream(entry.getValue().getShape()).boxed().collect(Collectors.toList())));
  ...
  public DualNumber(DoubleTensor value, VertexId infinitesimalLabel) {
    this(
        ...
        new PartialDerivatives(
            Collections.singletonMap(infinitesimalLabel, DoubleTensor.ones(value.getShape()))));
  }
  ...
  public DualNumber multiplyBy(DualNumber that) {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      thisInfMultiplied =
          this.partialDerivatives.multiplyAlongOfDimensions(that.value, this.getValue().getShape());
    }
    ...
    if (that.partialDerivatives.isEmpty()) {
      ...
      thatInfMultiplied =
          that.partialDerivatives.multiplyAlongOfDimensions(this.value, that.getValue().getShape());
    }
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      thisInfBase =
          this.partialDerivatives.multiplyAlongOfDimensions(
              that.value.times(this.value.pow(that.value.minus(1))), this.getValue().getShape());
    }
  ...
  public DualNumber exp() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(newValue, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber sin() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dSin, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber cos() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dCos, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber tan() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dTan, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber asin() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      DoubleTensor dArcSin =
          (value.unaryMinus().timesInPlace(value).plusInPlace(1)).sqrtInPlace().reciprocalInPlace();
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dArcSin, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber acos() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dArcCos, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber atan() {
    ...
    if (this.partialDerivatives.isEmpty()) {
      ...
      return new DualNumber(
          newValue,
          this.partialDerivatives.multiplyAlongOfDimensions(dArcTan, this.getValue().getShape()));
    }
  }
  ...
  public DualNumber take(int... index) {
    ...
    for (Map.Entry<VertexId, DoubleTensor> entry : this.partialDerivatives.asMap().entrySet()) {
      ...
      int[] paddedShape =
          TensorShape.shapeToDesiredRankByPrependingOnes(atIndexTensor.getShape(), desiredRank);
