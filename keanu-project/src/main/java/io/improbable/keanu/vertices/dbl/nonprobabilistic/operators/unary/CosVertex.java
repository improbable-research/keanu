...
public class CosVertex extends DoubleUnaryOpVertex implements Differentiable, SaveableVertex {
    ...
    public CosVertex(@LoadParentVertex(INPUT_VERTEX_NAME) DoubleVertex inputVertex) {
        super(inputVertex);
    }
