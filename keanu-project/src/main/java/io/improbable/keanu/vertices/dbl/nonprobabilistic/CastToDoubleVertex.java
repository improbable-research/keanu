...
public class CastToDoubleVertex<T extends NumberTensor> extends VertexImpl<DoubleTensor> implements DoubleVertex, NonProbabilistic<DoubleTensor>, VertexUnaryOp<IVertex<T>> {
