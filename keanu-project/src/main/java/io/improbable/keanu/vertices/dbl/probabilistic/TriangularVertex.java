...
public class TriangularVertex extends DoubleVertex implements ProbabilisticDouble {
   ...
   * @param xMin the xMin of the Triangular with either the same shape as specified for this vertex
   *     or a scalar
   * @param xMax the xMax of the Triangular with either the same shape as specified for this vertex
   *     or a scalar
  ...
  public TriangularVertex(DoubleVertex xMin, DoubleVertex xMax, DoubleVertex c) {
    this(
        checkHasSingleNonScalarShapeOrAllScalar(xMin.getShape(), xMax.getShape(), c.getShape()),
        xMin,
        xMax,
        c);
  }
