...
public class DoubleBinaryOpLambda<A, B> extends DoubleVertex
    ...
    protected final Function<PartialDerivatives, Map<Vertex, PartialDerivatives>>
    ...
    public DoubleBinaryOpLambda(
            int[] shape, Vertex<A> left, Vertex<B> right, BiFunction<A, B, DoubleTensor> op) {
    ...
    public DoubleBinaryOpLambda(
            Vertex<A> left, Vertex<B> right, BiFunction<A, B, DoubleTensor> op) {
        this(
                checkHasSingleNonScalarShapeOrAllScalar(left.getShape(), right.getShape()),
                left,
                right,
