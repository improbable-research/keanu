...
/**
 * An object representing the ID value of a vertex. IDs are assigned in such a way that a
 * Lexicographic ordering of all nodes based on their ID value is a valid topological ordering of
 * the graph made up by those vertices.
 *
 * <p>Ids also encapsulate the notion of "Depth". When we have graphs within graphs, the depth tells
 * us at what level the graph exists - ie depth 1 is the outermost graph, depth 2 is a graph within
 * a graph etc.
 */
@EqualsAndHashCode
