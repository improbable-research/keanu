...
public class SinVertex extends DoubleUnaryOpVertex implements Differentiable, SaveableVertex {
    ...
    public SinVertex(@LoadParentVertex(INPUT_VERTEX_NAME) DoubleVertex inputVertex) {
        super(inputVertex);
    }
