...
public class ConditionalProbabilityTable {
    ...
    @SafeVarargs
    public static CPTRawBuilder of(IVertex<? extends Tensor<?, ?>>... inputs) {
    ...
    public static class CPTRawBuilder {
        ...
        public CPTRawBuilder(List<IVertex<? extends Tensor<?, ?>>> inputs) {
            this.inputs = inputs;
        }
    ...
    public static class CPTWhenRawBuilder {
        ...
        public CPTWhenRawBuilder(List<?> condition, List<IVertex<? extends Tensor<?, ?>>> inputs) {
            this.condition = new CPTCondition(condition);
            this.inputs = inputs;
        }

        public <T> CPTBuilder<T> then(IVertex<GenericTensor<T>> thn) {
            Map<CPTCondition, IVertex<GenericTensor<T>>> conditions = new HashMap<>();
    ...
    public static class DoubleCPTBuilder {
        ...
        public DoubleCPTBuilder(List<IVertex<? extends Tensor<?, ?>>> inputs, Map<CPTCondition, DoubleVertex> conditions) {
            this.inputs = inputs;
    ...
    public static class BooleanCPTBuilder {
        ...
        public BooleanCPTBuilder(List<IVertex<? extends Tensor<?, ?>>> inputs, Map<CPTCondition, BooleanVertex> conditions) {
            this.inputs = inputs;
            this.conditions = conditions;
        }
    ...
    public static class IntegerCPTBuilder {
        ...
        public IntegerCPTBuilder(List<IVertex<? extends Tensor<?, ?>>> inputs, Map<CPTCondition, IntegerVertex> conditions) {
            this.inputs = inputs;
            this.conditions = conditions;
        }
    ...
    public static class CPTBuilder<T> {
        private final List<IVertex<? extends Tensor<?, ?>>> inputs;
        private final Map<CPTCondition, IVertex<GenericTensor<T>>> conditions;

        public CPTBuilder(List<IVertex<? extends Tensor<?, ?>>> inputs, Map<CPTCondition, IVertex<GenericTensor<T>>> conditions) {
            this.inputs = inputs;
            this.conditions = conditions;
        }
        ...
        public CPTVertex<T> orDefault(IVertex<GenericTensor<T>> defaultResult) {
        ...
        public static class CPTWhenBuilder<T> {
            ...
            public CPTBuilder<T> then(IVertex<GenericTensor<T>> thn) {
                builder.conditions.put(condition, thn);
                return builder;
            }
        }
