...
public class LogisticVertex extends VertexImpl<DoubleTensor> implements DoubleVertex, Differentiable, ProbabilisticDouble, SamplableWithManyScalars<DoubleTensor>, LogProbGraphSupplier {
    ...
    public LogProbGraph logProbGraph() {
        ...
        final DoublePlaceholderVertex sPlaceholder = new DoublePlaceholderVertex(s.getShape());
