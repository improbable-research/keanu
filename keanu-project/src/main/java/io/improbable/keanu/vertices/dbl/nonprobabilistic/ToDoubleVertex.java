...
public class ToDoubleVertex extends DoubleVertex implements NonProbabilistic<DoubleTensor> {

    private final Vertex<? extends NumberTensor> inputVertex;
    private static final String INPUT_NAME = "inputVertex";

    @ExportVertexToPythonBindings
    public ToDoubleVertex(@LoadVertexParam(INPUT_NAME) Vertex<? extends NumberTensor> inputVertex) {
    ...
    public DoubleTensor sample(KeanuRandom random) {
        return inputVertex.sample().toDouble();
    }
