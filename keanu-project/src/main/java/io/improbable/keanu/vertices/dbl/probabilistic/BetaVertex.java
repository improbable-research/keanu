...
public class BetaVertex extends DoubleVertex implements ProbabilisticDouble {
   ...
   *     vertex or a scalar
   * @param beta the beta of the Beta with either the same tensorShape as specified for this vertex
   *     or a scalar
   */
  ...
  ContinuousDistribution distribution() {
    return Beta.withParameters(
        alpha.getValue(), beta.getValue(), DoubleTensor.scalar(0.), DoubleTensor.scalar(1.));
  }
