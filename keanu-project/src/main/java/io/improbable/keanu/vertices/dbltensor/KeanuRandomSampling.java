...
class KeanuRandomSampling {
    ...
    public static double gammaSample(List<Double> parameters, Random random) {
        double a = parameters.get(0);
        double theta = parameters.get(1);
        double k = parameters.get(2);
        if (theta <= 0. || k <= 0.) {
    ...
    public static double laplaceSample(List<Double> params, Random random) {
        double mu = params.get(0);
        double beta = params.get(1);
        if (beta <= 0.0) {
