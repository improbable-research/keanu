...
public class IntegerProxyVertex extends VertexImpl<IntegerTensor, IntegerVertex> implements IntegerVertex, ProxyVertex<Vertex<IntegerTensor, ?>>, NonProbabilistic<IntegerTensor> {
    ...
    public IntegerProxyVertex(@LoadShape long[] shape,
                              @LoadVertexParam(LABEL_NAME) String labelString,
                              @LoadVertexParam(value = PARENT_NAME, isNullable = true) Vertex<IntegerTensor, ?> parent) {
        super(shape);
    ...
    @Override
    public void setParent(Vertex<IntegerTensor, ?> newParent) {
