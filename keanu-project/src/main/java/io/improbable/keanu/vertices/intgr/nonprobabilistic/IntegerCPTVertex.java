...
public class IntegerCPTVertex<IN> extends IntegerVertex implements NonProbabilistic<IntegerTensor>, NonSaveableVertex {
    ...
    public IntegerCPTVertex(List<Vertex<? extends Tensor<IN>>> inputs,
                           Map<CPTCondition<IN>, IntegerVertex> conditions,
