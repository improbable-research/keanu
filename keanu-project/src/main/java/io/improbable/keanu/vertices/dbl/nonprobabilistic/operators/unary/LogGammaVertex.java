...
public class LogGammaVertex extends DoubleUnaryOpVertex implements Differentiable, SaveableVertex {
    ...
    public LogGammaVertex(@LoadParentVertex(INPUT_VERTEX_NAME) DoubleVertex inputVertex) {
        super(inputVertex);
    }
