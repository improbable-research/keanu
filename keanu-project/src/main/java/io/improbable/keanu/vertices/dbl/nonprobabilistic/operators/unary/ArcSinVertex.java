...
public class ArcSinVertex extends DoubleUnaryOpVertex implements Differentiable, SaveableVertex {
    ...
    public ArcSinVertex(@LoadParentVertex(INPUT_VERTEX_NAME) DoubleVertex inputVertex) {
        super(inputVertex);
    }
