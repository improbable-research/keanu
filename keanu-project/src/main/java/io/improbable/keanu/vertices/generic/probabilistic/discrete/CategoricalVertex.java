...
public class CategoricalVertex<CATEGORY> extends GenericTensorVertex<CATEGORY> implements Probabilistic<Tensor<CATEGORY>>, NonSaveableVertex {
    ...
    @Override
    public Tensor<CATEGORY> sample(KeanuRandom random) {
    ...
    @Override
    public double logProb(Tensor<CATEGORY> value) {
    ...
    @Override
    public Map<Vertex, DoubleTensor> dLogProb(Tensor<CATEGORY> value, Set<? extends Vertex> withRespectTo) {
