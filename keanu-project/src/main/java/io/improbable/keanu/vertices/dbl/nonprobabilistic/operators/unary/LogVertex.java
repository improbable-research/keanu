...
public class LogVertex extends DoubleUnaryOpVertex implements Differentiable, SaveableVertex {
    ...
    public LogVertex(@LoadParentVertex(INPUT_VERTEX_NAME) DoubleVertex inputVertex) {
        super(inputVertex);
    }
