...
public class LogVertex extends DoubleUnaryOpVertex implements Differentiable {
    ...
    public LogVertex(@LoadVertexParam(INPUT_VERTEX_NAME) Vertex<DoubleTensor, ?> inputVertex) {
        super(inputVertex);
    }
    ...
    public PartialDerivative forwardModeAutoDifferentiation(Map<Vertex, PartialDerivative> derivativeOfParentsWithRespectToInput) {
        ...
        return derivativeOfParentWithRespectToInputs.divideByAlongOfDimensions(inputVertex.getValue());
    }
    ...
    public Map<Vertex, PartialDerivative> reverseModeAutoDifferentiation(PartialDerivative derivativeOfOutputWithRespectToSelf) {
        ...
        partials.put(inputVertex, derivativeOfOutputWithRespectToSelf
            .multiplyAlongWrtDimensions(inputVertex.getValue().reciprocal()));
        return partials;
    }
}
