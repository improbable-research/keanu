...
public class LessThanOrEqualVertex<A extends NumberTensor, B extends NumberTensor> extends BoolBinaryOpVertex<A, B> implements SaveableVertex {

    @ExportVertexToPythonBindings
    public LessThanOrEqualVertex(@LoadParentVertex(A_NAME) Vertex<A> a, @LoadParentVertex(B_NAME) Vertex<B> b) {
        super(a, b);
    }
