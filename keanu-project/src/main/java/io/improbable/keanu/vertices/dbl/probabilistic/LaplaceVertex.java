...
public class LaplaceVertex extends DoubleVertex implements Probabilistic<DoubleTensor> {
    ...
    public LaplaceVertex(int[] tensorShape, DoubleVertex mu, DoubleVertex beta) {
        super(new ProbabilisticValueUpdater<>(), Observable.observableTypeFor(LaplaceVertex.class));
    ...
    public Map<Long, DoubleTensor> dLogProb(DoubleTensor value) {
        ParameterMap<DoubleTensor> dlnP = Laplace.withParameters(mu.getValue(), beta.getValue()).dLogProb(value);
