...
public class MultivariateGaussianVertex extends DoubleVertex implements ProbabilisticDouble {
    ...
    /**
     * Matches a mu to a Multivariate Gaussian. The covariance value provided here is used to create
     * a covariance tensor by multiplying the scalar value against an identity matrix of the
     * appropriate size.
     *
     * @param mu the mu of the Multivariate Gaussian
