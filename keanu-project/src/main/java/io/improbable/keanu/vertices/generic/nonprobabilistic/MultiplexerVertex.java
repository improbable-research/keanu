...
public class MultiplexerVertex<T> extends GenericVertex<T> implements NonProbabilistic<T> {
    ...
    @Override
    public T calculate() {
        IVertex<T> selector = getSelector();
    ...
    public IVertex<T>[] getSelectVertices() {
