...
public class GreaterThanOrEqualVertex<A extends NumberTensor, B extends NumberTensor> extends BoolBinaryOpVertex<A, B> implements SaveableVertex {

    @ExportVertexToPythonBindings
    public GreaterThanOrEqualVertex(@LoadParentVertex(A_NAME) Vertex<A> a, @LoadParentVertex(B_NAME) Vertex<B> b) {
        super(a, b);
    }
