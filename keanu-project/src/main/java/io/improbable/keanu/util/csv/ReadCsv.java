...
public class ReadCsv {
  ...
  /**
   * This reads a file that is located in the src/main/resources folder. Files located there are by
   * default available on the class path in java. Loading it this way makes sure it can be loaded
   * from any platform from any current directory.
   *
