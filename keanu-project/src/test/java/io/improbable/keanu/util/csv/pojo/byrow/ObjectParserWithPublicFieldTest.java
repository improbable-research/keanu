...
public class ObjectParserWithPublicFieldTest {
  ...
  public void setup() {
    data =
        Arrays.asList(Arrays.asList("5", "A"), Arrays.asList("12", "6"), Arrays.asList("04", "L"));
  }
  ...
  public void givenSetToNotIgnoreFieldsThenThrowsExceptionForMissingField() {
    ...
    RowsAsObjectParser.stream(TestPOJOWithPublicFieldsClass.class, data.stream(), titles, false);
  }
