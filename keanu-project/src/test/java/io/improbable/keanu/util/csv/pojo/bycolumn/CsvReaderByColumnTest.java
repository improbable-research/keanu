...
public class CsvReaderByColumnTest {
  ...
  public void givenCsvStringThenLoadAsPOJO() {
    TestPOJO testPOJO = ReadCsv.fromString(csv).asVectorizedColumnsDefinedBy(TestPOJO.class).load();
  ...
  public void givenCsvStringThenLoadAsPOJOWithSetters() {
    TestPOJOWithSetters testPOJO =
        ReadCsv.fromString(csv).asVectorizedColumnsDefinedBy(TestPOJOWithSetters.class).load();
  ...
  public void givenCsvStringThenLoadAsPOJOWithAnnotations() {
    TestPOJOWithAnnotations testPOJO =
        ReadCsv.fromString(csv).asVectorizedColumnsDefinedBy(TestPOJOWithAnnotations.class).load();
