...
public class TensorShapeValidationTest {
  ...
  public void suggestSingleNonScalarShape() {
    int[] shapeProposal =
        TensorShapeValidation.checkHasSingleNonScalarShapeOrAllScalar(scalar1, twoByTwo1, scalar2);
  ...
  public void suggestMatchingNonScalarShape() {
    int[] shapeProposal =
        TensorShapeValidation.checkHasSingleNonScalarShapeOrAllScalar(
            scalar1, twoByTwo1, twoByTwo2);
    assertArrayEquals(new int[] {2, 2}, shapeProposal);
  }
  ...
  public void suggestScalar() {
    int[] shapeProposal =
        TensorShapeValidation.checkHasSingleNonScalarShapeOrAllScalar(scalar1, scalar2);
  ...
  public void rejectsShapeNotMatchingParent() {
    TensorShapeValidation.checkTensorsMatchNonScalarShapeOrAreScalar(
        new int[] {2, 4}, twoByTwo1, scalar1);
  }

  @Test(expected = IllegalArgumentException.class)
  public void rejectsMoreThanSingleNonScalarParent() {
    TensorShapeValidation.checkTensorsMatchNonScalarShapeOrAreScalar(
        new int[] {2, 2}, twoByTwo1, twoByThree);
  }

  @Test
  public void acceptsMatchingParentsShape() {
    TensorShapeValidation.checkTensorsMatchNonScalarShapeOrAreScalar(
        new int[] {2, 2}, twoByTwo1, scalar1);
  }

  @Test
  public void acceptsNonScalarToScalarParentShape() {
    TensorShapeValidation.checkTensorsMatchNonScalarShapeOrAreScalar(
        new int[] {2, 4}, scalar2, scalar1);
  }
}
