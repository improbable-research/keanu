...
public class Nd4jIntegerTensorTest {
    ...
    public void doesCompareLessThan() {
        IntegerTensor matrix = Nd4jIntegerTensor.create(new int[] {1, 2, 3, 4}, new int[] {2, 2});
        IntegerTensor otherMatrix =
                Nd4jIntegerTensor.create(new int[] {0, 2, 4, 7}, new int[] {2, 2});
    ...
    private void assertDropsFractionCorrectlyOnDivision(int numerator, int denominator) {
        ...
        IntegerTensor tensor =
                IntegerTensor.create(
                        new int[] {numerator, numerator, numerator, numerator}, new int[] {2, 2});
        IntegerTensor result = tensor.div(denominator);
        assertArrayEquals(
                new int[] {expected, expected, expected, expected}, result.asFlatIntegerArray());
    }

    @Test
    public void canResultInMaxInteger() {
        IntegerTensor tensor = IntegerTensor.create(new int[] {0, 0, 0, 0}, new int[] {2, 2});
    ...
    public void canRepresentAllValues() {
        ...
        assertArrayEquals(
                new int[] {biggestBitRange, biggestBitRange, biggestBitRange, biggestBitRange},
    ...
    public void youCanCheckForZeros() {
        IntegerTensor containsZero =
                IntegerTensor.create(
                        new int[] {0, -1, Integer.MAX_VALUE, Integer.MIN_VALUE, -0, 1}, 3, 2);
    ...
    public void youCanFixACustomValidationIssueByReplacingTheValue() {
        ...
        TensorValidator<Integer, IntegerTensor> validator =
                TensorValidator.thatFixesElementwise(
                        x -> x >= 0, TensorValidationPolicy.changeValueTo(0));
        containsMinusOne = validator.validate(containsMinusOne);
        assertThat(containsMinusOne, equalTo(expectedResult));
    }
}
