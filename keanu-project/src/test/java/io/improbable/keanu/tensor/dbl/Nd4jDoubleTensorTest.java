...
public class Nd4jDoubleTensorTest {
    ...
    @Test
    public void memory() {
        DoubleTensor a = Nd4jDoubleTensor.ones(1000, 1);
        DoubleTensor b = Nd4jDoubleTensor.ones(1000, 1);
        DoubleTensor result = a.minus(b);
        System.out.println(Arrays.toString(result.getShape()));
    }
