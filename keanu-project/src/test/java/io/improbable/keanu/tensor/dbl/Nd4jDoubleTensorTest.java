...
public class Nd4jDoubleTensorTest {
    ...
    public void canElementWiseMultiplyMatrix() {
        ...
        assertArrayEquals(new double[]{1, 4, 9, 16}, result.getFlattenedView().asDoubleArray(), 0.0);
    }

    @Test
    public void canMultiplyMatrixByScalar() {
        DoubleTensor result = matrixA.times(scalarA);
        assertArrayEquals(new double[]{2, 4, 6, 8}, result.getFlattenedView().asDoubleArray(), 0.0);
    }
    ...
    public void canElementWiseDivideMatrix() {
        ...
        assertArrayEquals(new double[]{1.0, 1.0, 1.0, 1.0}, result.getFlattenedView().asDoubleArray(), 0.0);
    }

    @Test
    public void canDivideMatrixByScalar() {
        DoubleTensor result = matrixA.div(scalarA);
        assertArrayEquals(new double[]{1.0 / 2.0, 2.0 / 2.0, 3.0 / 2.0, 4.0 / 2.0}, result.getFlattenedView().asDoubleArray(), 0.0);
    }

    @Test
    public void canDivideScalarByMatrix() {
        DoubleTensor result = scalarA.div(matrixA);
        assertArrayEquals(new double[]{2.0 / 1.0, 2.0 / 2.0, 2.0 / 3.0, 2.0 / 4.0}, result.getFlattenedView().asDoubleArray(), 0.0);
    }
    ...
    public void canSetWhereGreaterThanAMatrix() {
        ...
        assertArrayEquals(new double[]{1, 2, -2, -2}, result.getFlattenedView().asDoubleArray(), 0.0);
    }
    ...
    public void canSetWhereLessThanOrEqualAMatrix() {
        ...
        assertArrayEquals(new double[]{-2, -2, 3, 4}, result.getFlattenedView().asDoubleArray(), 0.0);
    }
    ...
    public void canApplyUnaryFunctionToRank3() {
        ...
        assertArrayEquals(new double[]{2, 4, 6, 8, 10, 12, 14, 16}, result.getFlattenedView().asDoubleArray(), 0.0);
    }
