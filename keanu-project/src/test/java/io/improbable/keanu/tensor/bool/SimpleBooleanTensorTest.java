...
public class SimpleBooleanTensorTest {
  ...
  public void setup() {
    ...
    matrixA =
        SimpleBooleanTensor.create(new boolean[] {true, false, true, false}, new int[] {2, 2});
    matrixB =
        SimpleBooleanTensor.create(new boolean[] {false, false, true, true}, new int[] {2, 2});
  ...
  public void doesSetDoubleIf() {
    DoubleTensor trueCase =
        DoubleTensor.create(new double[] {1.5, 2.0, 3.3, 4.65}, new int[] {2, 2});
    DoubleTensor falseCase =
        DoubleTensor.create(new double[] {5.1, 7.2, 11.4, 23.22}, new int[] {2, 2});
  ...
  public void doesSetGenericIf() {
    ...
    Tensor<Something> trueCase =
        new GenericTensor<>(
            new Something[] {Something.A, Something.B, Something.C, Something.D}, new int[] {2, 2});

    Tensor<Something> falseCase =
        new GenericTensor<>(
            new Something[] {Something.D, Something.C, Something.C, Something.A}, new int[] {2, 2});

    Tensor<Something> result = matrixA.setIf(trueCase, falseCase);
    assertArrayEquals(
        new Something[] {Something.A, Something.C, Something.C, Something.A}, result.asFlatArray());
  }

  @Test
  public void doesAllTrue() {
    assertFalse(
        new SimpleBooleanTensor(new boolean[] {false, true, false, false}, new int[] {2, 2})
            .allTrue());
    assertTrue(
        new SimpleBooleanTensor(new boolean[] {true, true, true, true}, new int[] {2, 2})
            .allTrue());
  }
  ...
  public void doesAllFalse() {
    assertFalse(
        new SimpleBooleanTensor(new boolean[] {false, true, false, false}, new int[] {2, 2})
            .allFalse());
    assertTrue(
        new SimpleBooleanTensor(new boolean[] {false, false, false, false}, new int[] {2, 2})
            .allFalse());
  }
