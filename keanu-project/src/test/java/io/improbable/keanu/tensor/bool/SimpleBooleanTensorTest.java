...
public class SimpleBooleanTensorTest {
    ...
    public void setup() {
        ...
        matrixA =
                SimpleBooleanTensor.create(
                        new boolean[] {true, false, true, false}, new int[] {2, 2});
        matrixB =
                SimpleBooleanTensor.create(
                        new boolean[] {false, false, true, true}, new int[] {2, 2});
        matrixC =
                SimpleBooleanTensor.create(
                        new boolean[] {true, true, true, false}, new int[] {2, 2});
    }
