...
public class BoundsCalculatorTest {
    ...
    public void calculatesBoundsWhenAllAreSpecified() {
        ...
        ApacheMathSimpleBoundsCalculator boundsCalculator =
                new ApacheMathSimpleBoundsCalculator(Double.POSITIVE_INFINITY, bounds);

        ImmutableList<DoubleVertex> latentVertices = ImmutableList.of(A);
        SimpleBounds simpleBounds =
                boundsCalculator.getBounds(latentVertices, new double[] {0, 0, 0});
    ...
    public void calculatesBoundsWhenNotAllAreSpecified() {
        ...
        ApacheMathSimpleBoundsCalculator boundsInfCalculator =
                new ApacheMathSimpleBoundsCalculator(Double.POSITIVE_INFINITY, bounds);
        SimpleBounds boundsA =
                boundsInfCalculator.getBounds(
                        latentVertices, new double[] {0, 0, 0, 0, 0, 0, 0, 0});

        assertArrayEquals(
                new double[] {
                    -2, -1, Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, -2, -1, -3, -4
                },
                boundsA.getLower(),
                0.0);
        ...
        ApacheMathSimpleBoundsCalculator bounds20Calculator =
                new ApacheMathSimpleBoundsCalculator(20, bounds);
        SimpleBounds boundsB =
                bounds20Calculator.getBounds(latentVertices, new double[] {0, 0, 0, 0, 0, 0, 0, 0});
