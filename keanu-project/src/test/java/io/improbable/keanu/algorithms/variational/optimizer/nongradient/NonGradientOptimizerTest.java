...
public class NonGradientOptimizerTest {
  ...
  public void doesCallOnFitnessHandler() {
    ...
    NonGradientOptimizer optimizer =
        NonGradientOptimizer.ofConnectedGraph(new GaussianVertex(new GaussianVertex(0, 1), 1));
  ...
  public void canFindMAPGivenBounds() {
    ...
    DoubleVertex A =
        new GaussianVertex(new int[] {1, 2}, ConstantVertex.of(new double[] {1, -3}), 1);
