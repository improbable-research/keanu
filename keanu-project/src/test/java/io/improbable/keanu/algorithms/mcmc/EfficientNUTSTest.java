...
public class EfficientNUTSTest {
    ...
    public void samplesGaussian() {
        ...
        NetworkSamples posteriorSamples = EfficientNUTS.getPosteriorSamples(
                bayesNet,
                Arrays.asList(A),
                100000,
                0.1,
...
//        Vizer.histogram(posteriorSamples.get(A).asList());
    ...
    public void samplesFromDonut() {
        ...
        NetworkSamples samples = EfficientNUTS.getPosteriorSamples(
                bayesNet,
                Arrays.asList(A, B),
                25000,
                0.005,
