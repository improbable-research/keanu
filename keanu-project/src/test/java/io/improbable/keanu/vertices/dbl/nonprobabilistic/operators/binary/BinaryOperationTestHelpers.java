...
public class BinaryOperationTestHelpers {
  ...
  public static void operatesOnTwoScalarVertexValues(
      double aValue,
      double bValue,
      double expected,
  ...
  public static void calculatesDualNumberOfTwoScalars(
      double aValue,
      double bValue,
    ...
    PartialDerivatives wrtReverse =
        Differentiator.reverseModeAutoDiff(output, ImmutableSet.of(A, B));
  ...
  public static void operatesOnTwo2x2MatrixVertexValues(
      double[] aValues,
      double[] bValues,
      double[] expected,
      BiFunction<DoubleVertex, DoubleVertex, DoubleVertex> op) {
  ...
  public static void calculatesDualNumberOfTwoMatricesElementWiseOperator(
      DoubleTensor aValues,
    ...
    assertArrayEquals(
        expectedGradientWrtA.asFlatDoubleArray(), wrtAForward.asFlatDoubleArray(), 1e-10);
    assertArrayEquals(expectedGradientWrtA.getShape(), wrtAForward.getShape());

    DoubleTensor wrtBForward = wrtForward.withRespectTo(B);
    assertArrayEquals(
        expectedGradientWrtB.asFlatDoubleArray(), wrtBForward.asFlatDoubleArray(), 1e-10);
    ...
    assertArrayEquals(
        expectedGradientWrtA.asFlatDoubleArray(), wrtAReverse.asFlatDoubleArray(), 1e-10);
    assertArrayEquals(expectedGradientWrtA.getShape(), wrtAReverse.getShape());

    DoubleTensor wrtBReverse = wrtReverse.withRespectTo(B);
    assertArrayEquals(
        expectedGradientWrtB.asFlatDoubleArray(), wrtBReverse.asFlatDoubleArray(), 1e-10);
    assertArrayEquals(expectedGradientWrtB.getShape(), wrtBReverse.getShape());
  }

  public static void calculatesDualNumberOfAVectorAndScalar(
      DoubleTensor aValues,
      double bValue,
      DoubleTensor expectedGradientWrtA,
      DoubleTensor expectedGradientWrtB,
  ...
  public static void calculatesDualNumberOfAScalarAndVector(
      double aValue,
      DoubleTensor bValues,
      DoubleTensor expectedGradientWrtA,
      DoubleTensor expectedGradientWrtB,
