...
public class HalfGaussianVertexTest {
    ...
    public void matchesKnownLogDensityOfScalar() {
        ...
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfScalar(
                tensorGaussianVertex, 0.5, expectedDensity);
    }
    ...
    public void matchesKnownLogDensityOfNegativeScalar() {
        ...
        HalfGaussianVertex tensorGaussianVertex = new HalfGaussianVertex(1);
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfScalar(
                tensorGaussianVertex, -0.5, Double.NEGATIVE_INFINITY);
    }
    ...
    public void matchesKnownLogDensityOfVector() {
        ...
        double expectedLogDensity =
                distribution.logDensity(0.25) + distribution.logDensity(0.75) + 2 * Math.log(2);
        HalfGaussianVertex tensorGaussianVertex = new HalfGaussianVertex(1);
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfVector(
                tensorGaussianVertex, new double[] {0.25, 0.75}, expectedLogDensity);
    }
    ...
    public void matchesKnownLogDensityOfNegativeVector() {
        ...
        HalfGaussianVertex tensorGaussianVertex = new HalfGaussianVertex(1);
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfVector(
                tensorGaussianVertex, new double[] {-0.25, 0.75}, Double.NEGATIVE_INFINITY);
    }
    ...
    public void matchesKnownDerivativeLogDensityOfScalar() {
        ...
        Map<Vertex, DoubleTensor> actualDerivatives =
                tensorGaussianVertex.dLogPdf(0.5, sigmaTensor, tensorGaussianVertex);

        assertEquals(gaussianLogDiff.dPdsigma, actualDerivatives.get(sigmaTensor).scalar(), 1e-5);
        assertEquals(
                gaussianLogDiff.dPdx, actualDerivatives.get(tensorGaussianVertex).scalar(), 1e-5);
    }
    ...
    public void isTreatedAsConstantWhenObserved() {
        HalfGaussianVertex vertexUnderTest = new HalfGaussianVertex(3.0);
    ...
    public void gaussianSampleMethodMatchesLogProbMethod() {
        ...
        HalfGaussianVertex vertex =
                new HalfGaussianVertex(new int[] {sampleCount, 1}, ConstantVertex.of(2.0));
    ...
    public void inferHyperParamsFromSamples() {
        ...
        VertexVariationalMAP.inferHyperParamsFromSamples(
                hyperParams ->
                        new HalfGaussianVertex(new int[] {numSamples, 1}, hyperParams.get(0)),
                sigma,
                latentSigmaList,
                random);
    }
