...
public class IntegerConcatenationVertexTest {
  ...
  public void canConcatMatricesOfSameSize() {
    IntegerVertex m =
        new ConstantIntegerVertex(
            Nd4jIntegerTensor.create(new int[] {1, 2, 3, 4}, new int[] {2, 2}));
    IntegerVertex a =
        new ConstantIntegerVertex(
            Nd4jIntegerTensor.create(new int[] {10, 15, 20, 25}, new int[] {2, 2}));
  ...
  public void canConcatHighDimensionalShapes() {
    IntegerVertex a =
        new ConstantIntegerVertex(
            Nd4jIntegerTensor.create(new int[] {1, 2, 3, 4, 5, 6, 7, 8}, new int[] {2, 2, 2}));
    IntegerVertex b =
        new ConstantIntegerVertex(
            Nd4jIntegerTensor.create(
                new int[] {10, 20, 30, 40, 50, 60, 70, 80}, new int[] {2, 2, 2}));
