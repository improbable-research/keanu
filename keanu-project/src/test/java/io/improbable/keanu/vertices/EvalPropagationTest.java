...
public class EvalPropagationTest {
  ...
  private void assertDoesNotDoUnnecessaryOperationsOnVerticesThatShareParents(
    ...
    DoubleVertex middleSum1 =
        TestGraphGenerator.sumVertex(start1, start2, n, m, id -> log.info("OP on id:" + id));
    DoubleVertex middleSum2 =
        TestGraphGenerator.sumVertex(start2, start3, n, m, id -> log.info("OP on id:" + id));
  ...
  public void doesNotRedoWorkAlreadyDoneOnLazyEval() {
    ...
    DoubleVertex pluck0 =
        blackBox.lambda(blackBox.getShape(), bb -> DoubleTensor.scalar(bb.getValue(0)), null, null);
    DoubleVertex pluck1 =
        blackBox.lambda(blackBox.getShape(), bb -> DoubleTensor.scalar(bb.getValue(1)), null, null);
    DoubleVertex pluck2 =
        blackBox.lambda(blackBox.getShape(), bb -> DoubleTensor.scalar(bb.getValue(2)), null, null);
