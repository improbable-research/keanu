...
public class DoubleIfVertexTest {
  ...
  public void canExtractDualNumberFromTruePredicate() {
    BoolVertex bool =
        new ConstantBoolVertex(BooleanTensor.create(new boolean[] {true, true, true, true}, 2, 2));
    ...
    BoolVertex bool =
        new ConstantBoolVertex(
            BooleanTensor.create(
                new boolean[] {true, true, true, false, true, true, true, false}, 2, 2, 2));
  ...
  public void canExtractDualNumberFromMixedPredicateWithDifferentParentsRankThree() {
    BoolVertex bool =
        new ConstantBoolVertex(
            BooleanTensor.create(
                new boolean[] {true, false, true, false, true, false, true, false}, 2, 2, 2));
