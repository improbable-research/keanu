...
public class DualNumberTensorTest {
  ...
  public void diffWrtVectorOverMultipleMultiplies() {
    ...
    DoubleTensor expectedWrt =
        DoubleTensor.create(new double[] {4, 16, 36, 64})
            .diag()
  ...
  public void diffWrtScalarOverMultipleMultiplies() {
    ...
    DoubleTensor expectedWrt =
        DoubleTensor.create(new double[] {4, 16, 36, 64}).reshape(1, 4, 1, 1);
  ...
  public void diffWrtScalarOverMultipleMultipliesAndSummation() {
    ...
    // B = 1*(a00 + a01 + a10 + a11) + 2*(a00 + a01 + a10 + a11)+ 3*(a00 + a01 + a10 + a11)+
    // 4*(a00
    // + a01 + a10 + a11)
    // dBda00 = 1 + 2 + 3 + 4 = 10
    DoubleTensor expectedWrt =
        DoubleTensor.create(new double[] {10, 10, 10, 10}).reshape(1, 1, 2, 2);
