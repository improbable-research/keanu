...
public class TakeVertexTest {
    ...
    public void takeFromVectorCorrectlyTakesPartialToo() {
        ...
        DoubleTensor takePartialReverse = Differentiator.reverseModeAutoDiff(take, m, alpha).withRespectTo(m).get();
        ...
        DoubleTensor takePartial2Reverse = Differentiator.reverseModeAutoDiff(take2, m, alpha).withRespectTo(m).get();
    ...
    public void takeFromMatrixMultiplyCorrectlyTakesPartialToo() {
        ...
        DoubleTensor takeDiffReverse = Differentiator.reverseModeAutoDiff(take, m, alpha).withRespectTo(alpha).get();
    ...
    public void shapeOfPartialCorrectlyPassesThroughTake() {
        ...
        DoubleTensor dFWrtAReverse = Differentiator.reverseModeAutoDiff(F, A, B).withRespectTo(A).get();
