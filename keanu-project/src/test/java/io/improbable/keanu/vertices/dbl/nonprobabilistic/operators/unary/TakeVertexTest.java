...
public class TakeVertexTest {
    ...
    public void takeFromVectorCorrectlyTakesPartialToo() {
        ...
        DoubleTensor takePartialReverse =
                Differentiator.reverseModeAutoDiff(take, m, alpha).withRespectTo(m);
        ...
        assertArrayEquals(
                takePartial.asFlatDoubleArray(), takePartialReverse.asFlatDoubleArray(), 1e-6);

        TakeVertex take2 = new TakeVertex(N, 0, 1);
        DoubleTensor takePartial2 = take2.getDualNumber().getPartialDerivatives().withRespectTo(m);
        DoubleTensor takePartial2Reverse =
                Differentiator.reverseModeAutoDiff(take2, m, alpha).withRespectTo(m);
        ...
        assertArrayEquals(
                takePartial2.asFlatDoubleArray(), takePartial2Reverse.asFlatDoubleArray(), 1e-6);
    }
    ...
    public void takeFromMatrixMultiplyCorrectlyTakesPartialToo() {
        ...
        DoubleTensor takeDualReverse =
                Differentiator.reverseModeAutoDiff(take, m, alpha).withRespectTo(alpha);
    ...
    public void shapeOfPartialCorrectlyPassesThroughTake() {
        ...
        assertArrayEquals(
                ...
                reverse.withRespectTo(A).asFlatDoubleArray(),
                1e-6);
    }
    ...
    public void changesMatchGradient() {
        ...
        finiteDifferenceMatchesGradient(
                ImmutableList.of(inputA, inputB), outputVertex, 10.0, 1e-10, true);
    }
}
