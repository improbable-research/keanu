...
public class ArcTan2VertexTest {
    ...
    public void tan2TwoScalarVertexValues() {
        operatesOnTwoScalarVertexValues(
                1.0, Math.PI, Math.atan2(Math.PI, 1.0), DoubleVertex::atan2);
    }
    ...
    public void tan2MatrixVertexValues() {
        operatesOnTwo2x2MatrixVertexValues(
                ...
                new double[] {
                    Math.atan2(2., 0.), Math.atan2(4, .1), Math.atan2(3, .2), Math.atan2(8, .3)
                },
                DoubleVertex::atan2);
    }
    ...
    public void calculatesDualNumberOfTwoMatricesElementWiseTan2() {
        calculatesDualNumberOfTwoMatricesElementWiseOperator(
                ...
                DoubleTensor.create(
                                new double[] {
                                    -2. / (1 + 4), -3. / (4 + 9), -4. / (9. + 16), -5. / (16 + 25)
                                })
                        .diag()
                        .reshape(1, 4, 1, 4),
                DoubleTensor.create(
                                new double[] {
                                    1. / (1 + 4), 2. / (4 + 9), 3. / (9 + 16), 4. / (16 + 25)
                                })
                        .diag()
                        .reshape(1, 4, 1, 4),
                DoubleVertex::atan2);
