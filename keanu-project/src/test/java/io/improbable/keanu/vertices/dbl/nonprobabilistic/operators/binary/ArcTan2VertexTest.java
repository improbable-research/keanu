...
public class ArcTan2VertexTest {
  ...
  public void tan2TwoScalarVertexValues() {
    operatesOnTwoScalarVertexValues(1.0, Math.PI, Math.atan2(Math.PI, 1.0), DoubleVertex::atan2);
  }
  ...
  public void calculatesDualNumberOfTwoScalarsTan2() {
    ...
    calculatesDualNumberOfTwoScalars(x, y, wrtX, wrtY, DoubleVertex::atan2);
  }
  ...
  public void calculatesDualNumberOfTwoMatricesElementWiseTan2() {
    calculatesDualNumberOfTwoMatricesElementWiseOperator(
        ...
        DoubleTensor.create(
                new double[] {-2. / (1 + 4), -3. / (4 + 9), -4. / (9. + 16), -5. / (16 + 25)})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleTensor.create(
                new double[] {1. / (1 + 4), 2. / (4 + 9), 3. / (9 + 16), 4. / (16 + 25)})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleVertex::atan2);
  }
  ...
  public void calculatesDualNumberOfAVectorsAndScalarTan2() {
    calculatesDualNumberOfAVectorAndScalar(
        ...
        2,
        DoubleTensor.create(
                new double[] {-2. / (1. + 4.), -2. / (4. + 4.), -2. / (9. + 4.), -2. / (16. + 4.)})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleTensor.create(
                new double[] {1. / (1. + 4.), 2. / (4. + 4.), 3. / (9. + 4.), 4. / (16. + 4.)})
            .reshape(1, 4, 1, 1),
        DoubleVertex::atan2);
  }
  ...
  public void calculatesDualNumberofAScalarAndVectorsTan2() {
    calculatesDualNumberOfAScalarAndVector(
        ...
        DoubleTensor.create(new double[] {1.0, 2.0, 3.0, 4.0}),
        DoubleTensor.create(
                new double[] {-1. / (4. + 1.), -2. / (4. + 4.), -3. / (4. + 9.), -4. / (4. + 16.)})
            .reshape(1, 4, 1, 1),
        DoubleTensor.create(
                new double[] {2. / (4. + 1.), 2. / (4. + 4.), 2. / (4. + 9.), 2. / (4. + 16.)})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleVertex::atan2);
  }
