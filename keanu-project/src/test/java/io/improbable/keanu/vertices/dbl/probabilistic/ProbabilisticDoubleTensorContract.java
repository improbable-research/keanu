...
public class ProbabilisticDoubleTensorContract {
  ...
  public static <V extends DoubleVertex & ProbabilisticDouble> void isTreatedAsConstantWhenObserved(
      V vertexUnderTest) {
  ...
  public static void matchesKnownLogDensityOfVector(
      Probabilistic<DoubleTensor> vertexUnderTest, double[] vector, double expectedLogDensity) {
