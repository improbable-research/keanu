...
public class SigmoidVertexTest {
    ...
    public void sigmoidScalarVertexValue() {
        operatesOnScalarVertexValue(5, sigmoid.value(5), DoubleVertex::sigmoid);
    }

    @Test
    public void calculatesDualNumberOScalarSigmoid() {
        calculatesDualNumberOfScalar(
                0.5, Math.exp(0.5) / Math.pow(Math.exp(0.5) + 1., 2), DoubleVertex::sigmoid);
    }
    ...
    public void sigmoidMatrixVertexValues() {
        operatesOn2x2MatrixVertexValues(
                ...
                new double[] {
                    sigmoid.value(0.0), sigmoid.value(0.1), sigmoid.value(0.2), sigmoid.value(0.3)
                },
    ...
    public void changesMatchGradient() {
        ...
        finiteDifferenceMatchesGradient(
                ImmutableList.of(inputVertex), outputVertex, 0.001, 1e-6, true);
    }
}
