...
public class ProcessModelVertexTest {
    ...
    public void canRunAModelInAModel() {
        ...
        Map<VertexLabel, IVertex<? extends Tensor>> inputs = ImmutableMap.of(new VertexLabel("Temperature"), inputToModel);
    ...
    public void modelInsideVertexIsRecalculatedOnEachParentSample() {
        ...
        Map<VertexLabel, IVertex<? extends Tensor>> inputs = ImmutableMap.of(new VertexLabel("Temperature"), probabilisticInput);
    ...
    private String formatCommandForExecution(Map<VertexLabel, IVertex<? extends Tensor>> inputs, String command) {
        for (Map.Entry<VertexLabel, io.improbable.keanu.vertices.IVertex<? extends Tensor>> input : inputs.entrySet()) {
