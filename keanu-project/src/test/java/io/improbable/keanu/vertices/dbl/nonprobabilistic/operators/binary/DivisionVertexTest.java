...
public class DivisionVertexTest {
  ...
  public void dividesTwoScalarVertexValues() {
    operatesOnTwoScalarVertexValues(12.0, 3.0, 4.0, DoubleVertex::divideBy);
  }

  @Test
  public void calculatesDualNumberOfTwoScalarsDivided() {
    calculatesDualNumberOfTwoScalars(2.0, 3.0, 1.0 / 3.0, -2.0 / 9.0, DoubleVertex::divideBy);
  }
  ...
  public void calculatesDualNumberOfTwoMatricesElementWiseDivided() {
    calculatesDualNumberOfTwoMatricesElementWiseOperator(
        ...
        DoubleTensor.create(new double[] {1.0 / 2.0, 1.0 / 3.0, 1.0 / 4.0, 1.0 / 5.0})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleTensor.create(new double[] {-1.0 / 4.0, -2.0 / 9.0, -3.0 / 16.0, -4.0 / 25.0})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleVertex::divideBy);
  }
  ...
  public void calculatesDualNumberofAScalarAndVectorsMultiplied() {
    calculatesDualNumberOfAScalarAndVector(
        ...
        DoubleTensor.create(new double[] {-2.0 / 1.0, -2.0 / 4.0, -2.0 / 9.0, -2.0 / 16.})
            .diag()
            .reshape(1, 4, 1, 4),
        DoubleVertex::divideBy);
  }
