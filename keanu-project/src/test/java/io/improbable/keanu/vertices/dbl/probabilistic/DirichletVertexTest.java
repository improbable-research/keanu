...
public class DirichletVertexTest {
  ...
  public void flatUniformIfAllConcentrationValuesAreOne() {
    ...
    Assert.assertTrue(
        twoDimDirichletPdf1 == twoDimDirichletPdf2 && twoDimDirichletPdf2 == twoDimDirichletPdf3);
  ...
  public void dLogProbMatchesFiniteDifferenceCalculationFordPdconcentration() {
    ...
    for (double i = start; i < end; i = i + step) {
      ...
      concentrationHyperParam.setAndCascade(
          DoubleTensor.create(new double[] {values[0] - gradientDelta, values[1] - gradientDelta}));
      ...
      startingValue =
          Nd4jDoubleTensor.create(
              new double[] {dirchletValue[0] + step, dirchletValue[1] - step}, new int[] {1, 2});
    }
  }
