...
public class LambdaModelVertexTest {
  ...
  public void canRunAModelInAModel() {
    ...
    ModelVertex model =
        new LambdaModelVertex(inputs, weatherModel::modelExecution, weatherModel::updateValues);
  ...
  public void canRunAModelInAModelWithDifferentOutputTypes() {
    ...
    ModelVertex model =
        new LambdaModelVertex(
            inputs, weatherModel::modelExecution, weatherModel::updateValuesMultipleTypes);
