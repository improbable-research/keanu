...
public class IntegerSliceVertexTest {
    ...
    public void setup() {
        matrixA =
                new ConstantIntegerVertex(IntegerTensor.create(new int[] {1, 2, 3, 4, 5, 6}, 2, 3));
    }
    ...
    public void canGetTensorAlongDimensionOfRank3() {
        ...
        Assert.assertArrayEquals(
                new int[] {1, 2, 3, 4}, dimenZeroFace.getValue().asFlatIntegerArray());
        ...
        Assert.assertArrayEquals(
                new int[] {1, 2, 5, 6}, dimenOneFace.getValue().asFlatIntegerArray());
        ...
        Assert.assertArrayEquals(
                new int[] {1, 3, 5, 7}, dimenTwoFace.getValue().asFlatIntegerArray());
