...
public class MatrixMultiplicationVertexTest {
    ...
    public void canSimpleMatrixMultiply() {
        ...
        MatrixMultiplicationVertex mmul =
                new MatrixMultiplicationVertex(
                        ConstantVertex.of(matrixA), ConstantVertex.of(matrixB));
    ...
    public void canDoMatrixMultiply2x2() {
        ...
        PartialDerivatives dCdxReverse =
                Differentiator.reverseModeAutoDiff(c, new HashSet<>(Arrays.asList(a, b)));
        DoubleTensor dCdaReverse = dCdxReverse.withRespectTo(a);
        DoubleTensor dCdbReverse = dCdxReverse.withRespectTo(b);

        DoubleTensor expecteddCda =
                DoubleTensor.create(
                        new double[] {
                            5, 7,
                            0, 0,
        ...
        PartialDerivatives dDdxReverse =
                Differentiator.reverseModeAutoDiff(d, new HashSet<>(Arrays.asList(a, b)));
        DoubleTensor dDdaReverse = dDdxReverse.withRespectTo(a);
        DoubleTensor dDdbReverse = dDdxReverse.withRespectTo(b);

        DoubleTensor expecteddDda =
                DoubleTensor.create(
                        new double[] {
                            5, 0,
                            6, 0,
        ...
        PartialDerivatives dEdxReverse =
                Differentiator.reverseModeAutoDiff(e, new HashSet<>(Arrays.asList(a, b)));
    ...
    public void canDoMatrixMultiplyAutoDiff() {
        ...
        PartialDerivatives reverseModePartialDiff =
                Differentiator.reverseModeAutoDiff(N, new HashSet<>(Arrays.asList(m, alpha)));
        ...
        DoubleTensor expectedDNdm =
                DoubleTensor.create(new double[] {1, 2, 3, 4, 5, 6}, 1, 3, 1, 2);
    ...
    public void canDoDoubleMatrixMultiplyAutoDiff() {
        ...
        DoubleTensor expectedDydm = DoubleTensor.create(new double[] {23, 34, 31, 46}, 1, 2, 1, 2);
    ...
    public void canDoTripleMatrixMultiplyAutoDiff() {
        ...
        DoubleVertex m = new UniformVertex(0, 10);
        m.setValue(DoubleTensor.create(new double[] {1, 2}, 2, 1));
        ...
        DualNumber yDual = y.getDualNumber();
        PartialDerivatives dydx =
                Differentiator.reverseModeAutoDiff(y, new HashSet<>(Arrays.asList(alpha)));
    ...
    public void changesMatchGradient() {
        ...
        finiteDifferenceMatchesGradient(
                ImmutableList.of(inputA, inputB), outputVertex, INCREMENT, DELTA, true);
    }
}
