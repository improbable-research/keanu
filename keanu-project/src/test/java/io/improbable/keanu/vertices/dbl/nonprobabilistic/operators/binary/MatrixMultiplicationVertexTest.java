...
public class MatrixMultiplicationVertexTest {
    ...
    public void canDoMatrixMultiply2x2() {
        ...
        //of c wrt a,b
        DoubleTensor dCda = c.getDualNumber().withRespectTo(a);
        DoubleTensor dCdb = c.getDualNumber().withRespectTo(b);
        ...
        DoubleTensor dDda = d.getDualNumber().withRespectTo(a);
        DoubleTensor dDdb = d.getDualNumber().withRespectTo(b);
        ...
        //of e wrt a, b
        DoubleTensor dEda = e.getDualNumber().withRespectTo(a);
        DoubleTensor dEdb = e.getDualNumber().withRespectTo(b);
    ...
    public void canDoMatrixMultiplyAutoDiff() {
        ...
        DoubleTensor dNdmForward = NDual.withRespectTo(m);
        ...
        DoubleTensor dNdAlphaForward = NDual.withRespectTo(alpha);
    ...
    public void canDoDoubleMatrixMultiplyAutoDiff() {
        ...
        PartialDerivatives yDual = y.getDualNumber();
        PartialDerivatives dydx = Differentiator.reverseModeAutoDiff(y, m, alpha, beta);

        DoubleTensor dydmForward = yDual.withRespectTo(m);
        ...
        DoubleTensor dydalphaForward = yDual.withRespectTo(alpha);
        ...
        DoubleTensor dydbetaForward = yDual.withRespectTo(beta);
