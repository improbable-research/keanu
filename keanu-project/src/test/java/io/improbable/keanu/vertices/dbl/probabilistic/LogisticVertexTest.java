...
public class LogisticVertexTest {
    ...
    public void matchesKnownLogDensityOfScalar() {
        ...
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfScalar(
                tensorLogisticVertex, 2.0, expectedDensity);
    }
    ...
    public void matchesKnownLogDensityOfVector() {
        ...
        ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfVector(
                ndLogisticVertex, new double[] {0.25, .75}, expectedLogDensity);
    }
    ...
    public void matchesKnownDerivativeLogDensityOfScalar() {
        ...
        Map<Vertex, DoubleTensor> actualDerivatives =
                tensorLogisticVertex.dLogPdf(1.5, aTensor, bTensor, tensorLogisticVertex);
        ...
        assertEquals(
                logisticLogDiff.dPdx, actualDerivatives.get(tensorLogisticVertex).scalar(), 1e-5);
    }
    ...
    public void isTreatedAsConstantWhenObserved() {
        ...
        LogisticVertex vertexUnderTest = new LogisticVertex(mu, 3.);
    ...
    public void logisticSampleMethodMatchesLogProbMethod() {
        ...
        LogisticVertex vertex =
                new LogisticVertex(
                        new int[] {sampleCount, 1}, ConstantVertex.of(0.0), ConstantVertex.of(0.5));
