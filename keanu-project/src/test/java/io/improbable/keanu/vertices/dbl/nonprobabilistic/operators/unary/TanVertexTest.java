...
public class TanVertexTest {
  ...
  public void tanScalarVertexValue() {
    operatesOnScalarVertexValue(Math.PI, Math.tan(Math.PI), DoubleVertex::tan);
  }

  @Test
  public void calculatesDualNumberOScalarTan() {
    calculatesDualNumberOfScalar(0.5, 1 / Math.pow(Math.cos(0.5), 2), DoubleVertex::tan);
  }
  ...
  public void changesMatchGradient() {
    ...
    finiteDifferenceMatchesGradient(
        ImmutableList.of(inputVertex), outputVertex, 0.0001, 1e-6, true);
  }
}
