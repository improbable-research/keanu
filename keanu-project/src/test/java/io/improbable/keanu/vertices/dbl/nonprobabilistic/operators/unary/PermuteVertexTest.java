...
public class PermuteVertexTest {
    ...
    @Test
    public void PermuteVertex() {
        DoubleVertex a = new UniformVertex(0, 10);
        a.setValue(DoubleTensor.create(new double[]{1, 2, 3, 4}, 2, 2));

        PermuteVertex PermuteVertex = new PermuteVertex(a, 4, 1);
        PermuteVertex.getValue();

        Assert.assertArrayEquals(new long[]{4, 1}, PermuteVertex.getShape());
        Assert.assertArrayEquals(new double[]{1, 2, 3, 4}, PermuteVertex.getValue().asFlatDoubleArray(), 1e-6);
    }
    ...
    public void reshapeCorrectlyReshapesPartialDerivative() {
        ...
        PermuteVertex reshapedN = new PermuteVertex(N, 4, 1);
    ...
    public void changesMatchGradient() {
        ...
        PermuteVertex outputVertex = inputVertex.times(1.5).reshape(2, 2, 2, 2);
