...
public class VertexValuePropagationTest {
  ...
  public void doesPropagateAroundProbabilisticVerticesOnCascade() {
    ...
    DoubleVertex secondLayerLeft =
        sumVertex(secondLayerStart, firstLayerEnd, n, m, id -> log.info("OP on id: " + id));
    DoubleVertex secondLayerRight =
        passThroughVertex(secondLayerStart, n, m, id -> log.info("OP on id: " + id));
    DoubleVertex secondLayerEnd =
        sumVertex(secondLayerLeft, secondLayerRight, n, m, id -> log.info("OP on id: " + id));
