...
public class ConcatenationVertexTest {
    ...
    public void canConcatVectorsOfSameSize() {
        ...
        Assert.assertArrayEquals(
                new double[] {1, 2, 3, 4, 5, 6}, concatZero.getValue().asFlatDoubleArray(), 0.001);
        Assert.assertArrayEquals(
    ...
    public void canConcatScalarToVector() {
        ...
        Assert.assertArrayEquals(
                new double[] {1, 2, 3, 4}, concat.getValue().asFlatDoubleArray(), 0.001);
    }
    ...
    public void canConcatMatricesOfSameSize() {
        ...
        Assert.assertArrayEquals(
                new double[] {1, 2, 3, 4, 10, 15, 20, 25},
                concatZero.getValue().asFlatDoubleArray(),
                0.001);
        ...
        Assert.assertArrayEquals(
                new double[] {1, 2, 10, 15, 3, 4, 20, 25},
                concatOne.getValue().asFlatDoubleArray(),
                0.001);
    }
    ...
    public void canConcatenateSimpleAutoDiff() {
        ...
        Assert.assertArrayEquals(
                DoubleTensor.concat(0, cPartial.withRespectTo(a), dPartial.withRespectTo(a))
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(a).asFlatDoubleArray(),
                0.0001);

        Assert.assertArrayEquals(
                DoubleTensor.concat(0, cPartial.withRespectTo(b), dPartial.withRespectTo(b))
                        .asFlatDoubleArray(),
    ...
    public void canConcatenateAutoDiffMatricesAlongDimensionZero() {
        ...
        DoubleTensor dCdshared =
                c.getDualNumber().getPartialDerivatives().withRespectTo(sharedMatrix);
        DoubleTensor dDdshared =
                d.getDualNumber().getPartialDerivatives().withRespectTo(sharedMatrix);

        ConcatenationVertex concat = new ConcatenationVertex(0, c, d);
        PartialDerivatives concatPartialForward = concat.getDualNumber().getPartialDerivatives();
        PartialDerivatives concatPartialReverse =
                Differentiator.reverseModeAutoDiff(concat, sharedMatrix, a, b);
        ...
        assertEquals(
                concatPartialForward.withRespectTo(sharedMatrix),
                concatPartialReverse.withRespectTo(sharedMatrix));

        DoubleTensor cwrtA = c.getDualNumber().getPartialDerivatives().withRespectTo(a);
        Assert.assertArrayEquals(
                DoubleTensor.concat(0, cwrtA, DoubleTensor.zeros(cwrtA.getShape()))
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(a).asFlatDoubleArray(),
                0.0001);
        ...
        Assert.assertArrayEquals(
                DoubleTensor.concat(0, DoubleTensor.zeros(dwrtB.getShape()), dwrtB)
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(b).asFlatDoubleArray(),
                0.0001);
    ...
    public void canConcatenateAutoDiffMatricesAlongDimensionOne() {
        ...
        DoubleTensor cwrtA = c.getDualNumber().getPartialDerivatives().withRespectTo(a);
        Assert.assertArrayEquals(
                DoubleTensor.concat(1, cwrtA, DoubleTensor.zeros(cwrtA.getShape()))
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(a).asFlatDoubleArray(),
                0.0001);
        ...
        DoubleTensor dwrtB = d.getDualNumber().getPartialDerivatives().withRespectTo(b);
        Assert.assertArrayEquals(
                DoubleTensor.concat(1, DoubleTensor.zeros(dwrtB.getShape()), dwrtB)
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(b).asFlatDoubleArray(),
                0.0001);
    ...
    public void canConcatenateAutoDiffOfManyMatricesAlongDimensionZero() {
        ...
        DoubleTensor dDdshared =
                d.getDualNumber().getPartialDerivatives().withRespectTo(sharedMatrix);
        DoubleTensor dEdshared =
                e.getDualNumber().getPartialDerivatives().withRespectTo(sharedMatrix);

        ConcatenationVertex concat = new ConcatenationVertex(0, c, d, e);
        PartialDerivatives concatPartialForward = concat.getDualNumber().getPartialDerivatives();
        PartialDerivatives concatPartialReverse =
                Differentiator.reverseModeAutoDiff(concat, sharedMatrix, a, b, f);
        ...
        Assert.assertArrayEquals(
                DoubleTensor.concat(
                                0,
                                cwrtA,
                                DoubleTensor.zeros(cwrtA.getShape()),
                                DoubleTensor.zeros(cwrtA.getShape()))
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(a).asFlatDoubleArray(),
                0.0001);
        ...
        Assert.assertArrayEquals(
                DoubleTensor.concat(
                                0,
                                DoubleTensor.zeros(dwrtB.getShape()),
                                dwrtB,
                                DoubleTensor.zeros(dwrtB.getShape()))
                        .asFlatDoubleArray(),
                concatPartialForward.withRespectTo(b).asFlatDoubleArray(),
        ...
        Assert.assertArrayEquals(
                DoubleTensor.concat(
                                0,
                                DoubleTensor.zeros(ewrtC.getShape()),
                                DoubleTensor.zeros(ewrtC.getShape()),
                                ewrtC)
                        .asFlatDoubleArray(),
    ...
    public void changesMatchGradient() {
        ...
        finiteDifferenceMatchesGradient(
                ImmutableList.of(inputA, inputB, inputC), outputVertex, 10.0, 1e-10, true);
    }
}
