...
public class ConcatenationVertexTest {
  ...
  public void canConcatVectorsOfSameSize() {
    ...
    Assert.assertArrayEquals(
        new double[] {1, 2, 3, 4, 5, 6, 7, 8, 9}, concatOne.getValue().asFlatDoubleArray(), 0.001);
  }
  ...
  public void canConcatVectorsOfDifferentSize() {
    ...
    Assert.assertArrayEquals(
        new double[] {1, 2, 3, 4, 5, 6, 7, 8, 9}, concatZero.getValue().asFlatDoubleArray(), 0.001);
  }
  ...
  public void canConcatMatricesOfSameSize() {
    ...
    Assert.assertArrayEquals(
        new double[] {1, 2, 10, 15, 3, 4, 20, 25}, concatOne.getValue().asFlatDoubleArray(), 0.001);
  }
