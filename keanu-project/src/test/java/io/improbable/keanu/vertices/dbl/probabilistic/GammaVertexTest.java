...
public class GammaVertexTest {
  ...
  public void matchesKnownLogDensityOfScalar() {
    ...
    ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfScalar(
        tensorGamma, 0.5, expectedDensity);
  }
  ...
  public void matchesKnownLogDensityOfVector() {
    ...
    ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfVector(
        tensorGamma, new double[] {1., 3.}, expectedLogDensity);
  }
  ...
  public void matchesKnownDerivativeLogDensityOfScalar() {
    ...
    Map<Vertex, DoubleTensor> actualDerivatives =
        tensorGamma.dLogPdf(Nd4jDoubleTensor.scalar(1.5), thetaTensor, kTensor, tensorGamma);
  ...
  public void gammaSampledMethodMatchesLogProbMethod() {
    ...
    GammaVertex vertex =
        new GammaVertex(new int[] {sampleCount, 1}, ConstantVertex.of(2.0), ConstantVertex.of(7.5));
  ...
  public void inferHyperParamsFromSamples() {
    ...
    VertexVariationalMAP.inferHyperParamsFromSamples(
        hyperParams ->
            new GammaVertex(new int[] {numSamples, 1}, hyperParams.get(0), hyperParams.get(1)),
        thetaK,
        latentThetaK,
        random);
  }
