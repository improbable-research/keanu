...
public class LaplaceVertexTest {
  ...
  public void matchesKnownLogDensityOfScalar() {
    ...
    ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfScalar(
        tensorLaplaceVertex, 0.5, expectedDensity);
  }
  ...
  public void matchesKnownLogDensityOfVector() {
    ...
    ProbabilisticDoubleTensorContract.matchesKnownLogDensityOfVector(
        ndLaplaceVertex, new double[] {0.25, 0.75}, expectedLogDensity);
  }
  ...
  public void matchesKnownDerivativeLogDensityOfScalar() {
    ...
    Map<Vertex, DoubleTensor> actualDerivatives =
        tensorLaplaceVertex.dLogPdf(0.5, muTensor, betaTensor, tensorLaplaceVertex);
  ...
  public void isTreatedAsConstantWhenObserved() {
    ...
    LaplaceVertex vertexUnderTest = new LaplaceVertex(mu, 3.0);
  ...
  public void laplaceSampleMethodMatchesLogProbMethod() {
    ...
    LaplaceVertex vertex =
        new LaplaceVertex(
            new int[] {sampleCount, 1}, ConstantVertex.of(0.0), ConstantVertex.of(2.0));
  ...
  public void inferHyperParamsFromSamples() {
    ...
    VertexVariationalMAP.inferHyperParamsFromSamples(
        hyperParams ->
            new LaplaceVertex(new int[] {numSamples, 1}, hyperParams.get(0), hyperParams.get(1)),
        muBeta,
        latentMuBeta,
        random);
  }
