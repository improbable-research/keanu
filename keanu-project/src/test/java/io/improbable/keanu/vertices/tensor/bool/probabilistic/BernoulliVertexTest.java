...
import static io.improbable.keanu.vertices.tensor.number.floating.dbl.probabilistic.ProbabilisticDoubleTensorContract.testGradientAcrossMultipleHyperParameterValues;
...
public class BernoulliVertexTest {
    ...
    public void doesCalculateDiffLogProbWithRespectToRank3HyperParam() {
        ...
        DoubleTensor expectedWrtA = AValue.reciprocal().where(
            atValue,
        ...
        DoubleTensor expectedWrtB = BValue.reciprocal().where(
            atValue,
    ...
    public void canUseWithGradientOptimizer() {
        ...
        DoubleTensor expected = DoubleTensor.scalar(max).where(
            observation,
