...
public class AutoDiffTensorTest {
    ...
    public void diffWrtVectorOverMultipleMultiplies() {
        ...
        DoubleTensor wrtA = Differentiator.reverseModeAutoDiff(output, A).withRespectTo(A).get();
    ...
    public void diffWrtScalarOverMultipleMultipliesAndSummation() {
        ...
        DoubleTensor wrtA = Differentiator.reverseModeAutoDiff(B, A).withRespectTo(A).get();
