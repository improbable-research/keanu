...
public class FoodPoisoningTest {
    ...
    private CategoricalVertex infectedOysters;
    private CategoricalVertex infectedLamb;
    private CategoricalVertex infectedToilet;

    @Before
    public void setup() {
        random = new KeanuRandom(1);
        infectedOysters = new CategoricalVertex(0.4);
        infectedLamb = new CategoricalVertex(0.4);
        infectedToilet = new CategoricalVertex(0.1);
    }
    ...
    public void generateSurveyData(int peopleCount, boolean oystersAreInfected, boolean lambIsInfected, boolean toiletIsInfected) {
        ...
        Consumer<Plate> personMaker = (plate) -> {
            CategoricalVertex didEatOysters = plate.add("didEatOysters", new CategoricalVertex(0.4));
            CategoricalVertex didEatLamb = plate.add("didEatLamb", new CategoricalVertex(0.4));
            CategoricalVertex didEatPoo = plate.add("didEatPoo", new CategoricalVertex(0.4));
            ...
            plate.add("pIll", pIll);
            plate.add("isIll", new CategoricalVertex(pIll));
        };
