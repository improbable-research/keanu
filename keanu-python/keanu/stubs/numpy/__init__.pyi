...
class _ArrayLike(Generic[_S]):
    ...
    def item(self, args: AxesType=None) -> generic: ...
...
def arange(start: int=None, stop: int=None, step: int=None, dtype: Any=None): ...
...
def ndenumerate(a: ndarray) -> Iterator[Any]: ...
...
def array_equal(a: _ArrayLike[Any], b: _ArrayLike[Any]) -> bool: ...
def allclose(a: Any, b: Any, rtol: float=1e-05, atol: float=1e-08, equal_nan: bool=False) -> bool: ...
def concatenate(a_tuple: List[_ArrayLike[Any]], axis: int=0, out: ndarray=None) -> ndarray: ...
...
def all(a: _ArrayLike[Any], axis: Union[int, Tuple[int, ...]]=None, out: ndarray=None, keepdims: bool_=_NoValue) -> Union[ndarray, bool_]: ...
def invert(x: _ArrayLike[Any], *args, **kwargs) -> ndarray: ...
def issubdtype(arg1: DtypeType, arg2: DtypeType) -> bool: ...
def hstack(tup: List[ndarray[Any]]) -> ndarray: ...
def stack(arrays: Sequence[_ArrayLike], axis: AxesType=None, out: ndarray=None) -> ndarray: ...
def atleast_1d(*arys: Any) -> ndarray: ...
def floor(x: _ArrayLike[Any], out: Union[ndarray[Any], Tuple[ndarray[Any]]]=None) -> ndarray: ...
def log10(x: _ArrayLike[Any], out: Union[ndarray[Any], Tuple[ndarray[Any]]]=None) -> ndarray: ...
def array_split(x: _ArrayLike[Any], indices_or_sections: int, axis: int=0) -> List[ndarray]: ...
