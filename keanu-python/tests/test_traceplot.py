...
@pytest.mark.mpl_image_compare(filename='test_traceplot_generates_correct_image_windows.png'
                               if os.name == 'nt' else 'test_traceplot_generates_correct_image_linux.png')
