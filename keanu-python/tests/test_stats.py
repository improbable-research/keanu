...
def test_can_get_autocorrelation_for_samples():
    with Model() as m:
    ...
    autocorr = stats.autocorrelation(samples.get(valid_key))


def test_cant_get_autocorrelation_of_np_bools():
    x = [True, False, False]
...
def test_cant_get_autocorrelation_of_np_ints():
    x = [1, 2, 3]
...
def test_cant_get_autocorrelation_of_non_scalar_arrays():
