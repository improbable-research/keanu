from keanu.cast import (cast_tensor_arg_to_double, cast_tensor_arg_to_integer, cast_tensor_arg_to_bool, cast_to_double,
                        cast_to_integer, cast_to_bool)
...
@pytest.mark.parametrize("cast_fn, expected_type", [(cast_tensor_arg_to_double, float), (cast_to_double, float),
                                                    (cast_tensor_arg_to_integer, int), (cast_to_integer, int),
                                                    (cast_tensor_arg_to_bool, bool), (cast_to_bool, bool)])
...
@pytest.mark.parametrize("cast_fn, expected_type", [(cast_tensor_arg_to_double, np.floating),
                                                    ...
                                                    (cast_to_integer, np.integer), (cast_tensor_arg_to_bool, np.bool_),
...
@pytest.mark.parametrize("cast_fn", [cast_to_double, cast_to_integer, cast_to_bool])
