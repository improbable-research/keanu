...
def test_num_passed_to_Tensor_creates_scalar_tensor(num, expected_class):
    t = kn.Tensor(num)
    assert_java_class(t, expected_class)
    assert t.isScalar()
...
def test_ndarray_passed_to_Tensor_creates_nonscalar_tensor(arr, expected_class):
