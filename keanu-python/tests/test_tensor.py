...
def test_num_passed_to_Tensor_creates_scalar_tensor(num, expected_java_class) -> None:
    t = Tensor(num)
...
def test_dataframe_passed_to_Tensor_creates_tensor(data, expected_java_class) -> None:
...
@pytest.mark.parametrize("data, expected_java_class", [([1, 2], "Nd4jIntegerTensor"), ([1], "ScalarIntegerTensor"),
                                                       ...
                                                       ([True], "SimpleBooleanTensor")])
def test_series_passed_to_Tensor_creates_tensor(data, expected_java_class) -> None:
...
@pytest.mark.parametrize("arr, expected_java_class", [([1, 2], "Nd4jIntegerTensor"), ([3.4, 2.], "Nd4jDoubleTensor"),
                                                      ([True, False], "SimpleBooleanTensor")])
def test_ndarray_passed_to_Tensor_creates_nonscalar_tensor(arr, expected_java_class) -> None:
...
def test_convert_java_tensor_to_ndarray(value) -> None:
    t = Tensor(value)
